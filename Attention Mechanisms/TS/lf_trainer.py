...
class LongformerScientificTrainer:
    def __init__(
        self,
        ...
        output_dir: str = "./longformer_scientific_models",
    ...
    def preprocess_function(self, examples, config):
        """Prepare examples for the model with Longformer-specific processing"""
        ...
        global_attention_mask = np.zeros((len(texts), self.max_length))
    ...
    def get_training_args(self, num_training_steps: int) -> TrainingArguments:
        ...
        return TrainingArguments(
            ...
            metric_for_best_model="rougeL_f1",  # Use ROUGE-L F1 as the primary metric
...
def main():
    # Initialize trainer
    trainer = LongformerScientificTrainer(
        model_name="allenai/longformer-base-4096",
        batch_size=4,
        max_length=4096,
        num_epochs=3,
        learning_rate=2e-5,
        output_dir="./longformer_scientific_models"
    )
